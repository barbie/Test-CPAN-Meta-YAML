package Test::CPAN::Meta::YAML::Version;
...
Test::CPAN::Meta::YAML::Version - Validate META.json elements.
...
This module is meant to be used together with L<Test::CPAN::Meta::YAML>, however
...
q( Currently Listening To: Rainbow - "Man On The Silver Mountain" from 'Outrage - Live in London 1981');
